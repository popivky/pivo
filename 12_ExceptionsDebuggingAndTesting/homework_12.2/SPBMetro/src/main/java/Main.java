...
public class Main {
    ...
    private static Logger inputErrors;
    private  static Logger exeptions;
    private static final String DATA_FILE = "C:\\Users\\79268\\Documents\\12_ExceptionsDebuggingAndTesting\\homework_12.2\\SPBMetro\\src\\main\\resources\\map.json";
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                loggerSearch.info("Найденные станции: " + station.getName());
                return station;
            }
            inputErrors.info("Ошибка при вводе: " + line);
